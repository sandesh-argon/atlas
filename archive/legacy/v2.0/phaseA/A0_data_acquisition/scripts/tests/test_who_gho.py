"""
A0.2 Test Script: WHO Global Health Observatory Scraper
Tests V1 scraper on 10 sample health indicators
"""
...
TEST_INDICATORS = [
    ...
    "WHS4_100",        # Total health expenditure as % of GDP
    "WHS4_543",        # Out-of-pocket expenditure as % of total expenditure on health
    "MDG_0000000026",  # Prevalence of underweight (children <5)
    "SA_0000001688",   # Physicians density (per 1,000 population)
    "MDG_0000000004",  # Maternal mortality ratio
    "WHS9_86",         # Hospital beds (per 10,000 population)
    "NUTRITION_ANAEMIA_CHILDREN_PREVALENCE"  # Prevalence of anaemia in children
]

OUTPUT_DIR = "./test_output/who"
BASE_URL = "https://ghoapi.azureedge.net/api/"
LOG_FILE = "./test_output/who_test_log.json"
...
def main():
    ...
    print("=" * 70)
    print("A0.2 TEST: WHO Global Health Observatory Scraper")
    print("=" * 70)
