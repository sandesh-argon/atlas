...
GRANGER_RESULTS = BASE_DIR / "A2_granger_causality" / "outputs" / "granger_test_results.pkl"
...
def save_results(results_df, significant_df, metadata, n_sig_005, n_sig_001):
    ...
    full_output = OUTPUT_DIR / "granger_fdr_corrected.pkl"
    ...
    sig_output = OUTPUT_DIR / "significant_edges_fdr.pkl"
