#!/usr/bin/env python3
"""
A4 Phase 3: Effect Estimation with LASSO-Regularized Parent Adjustment
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('logs/step3_effect_estimation.log'),
...
def load_checkpoint(checkpoint_path):
    ...
    edges_completed = checkpoint_data['edges_completed']
...
def run_effect_estimation(parent_sets_df, data, sample_size=None, n_jobs=12, bootstrap_n=100,
    ...
    for chunk_idx in range(n_chunks):
        ...
        # Checkpoint
        if (chunk_idx + 1) % 1 == 0 or chunk_idx == n_chunks - 1:
            checkpoint_path = f"checkpoints/effect_estimation_checkpoint_{edges_done}.pkl"
...
def main():
    ...
    parser.add_argument('--checkpoint_every', type=int, default=5000,
                        help='Checkpoint every N edges (default: 5000)')
    parser.add_argument('--output', type=str,
                        default='outputs/lasso_effect_estimates.pkl',
