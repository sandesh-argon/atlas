#!/usr/bin/env python3
"""
A2 Step 1: Load and Validate A1 Checkpoint (V2.1)
=================================================
Validates the preprocessed data from A1 before beginning Granger causality tests.

V2.1 MODIFICATION: Expects 3,122 indicators (stratified sample from 6,368)

Success Criteria:
- Indicator count: ~3,122 (V2.1 sampled)
...
from v21_config import A1_INPUT, A2_OUTPUT, get_input_path

# Get the actual checkpoint path
...
def main():
    ...
    all_checks = [
        ("Indicator count", indicator_count >= 3000),  # V2.1 target: 3122
