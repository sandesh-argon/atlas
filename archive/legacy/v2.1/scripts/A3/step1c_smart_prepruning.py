#!/usr/bin/env python3
"""
A3 Step 1c: Smart Pre-Pruning (V2.1)
Intelligently reduce edges to 50K-100K high-confidence edges
...
from v21_config import A2_OUTPUT, A3_OUTPUT
...
def smart_prepruning(input_file, fdr_cutoff=0.001, f_stat_min=10.0, corr_min=0.30):
    ...
    # Save results (V2.1: use A3_OUTPUT from config)
...
def main():
    ...
    # Input file (V2.1: use A2_OUTPUT from config)
    input_file = A2_OUTPUT / 'granger_fdr_corrected.pkl'
