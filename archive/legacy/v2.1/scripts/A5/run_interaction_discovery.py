#!/usr/bin/env python3
"""
A5 INTERACTION DISCOVERY - MAIN PIPELINE (V2.1)
================================================
...
Output: v2.1/outputs/A5/A5_interaction_results.pkl
"""
...
from v21_config import A5_OUTPUT, get_input_path
...
# Fix #1: Mechanism pairs (V2.1: use A5_OUTPUT)
...
# Fix #3: Control sets (V2.1: use A5_OUTPUT)
CONTROLS_PATH = A5_OUTPUT / 'precomputed_controls.pkl'
...
for outcome, pairs in interaction_pairs.items():
    for m1, m2 in pairs:
        ...
        if n_processed % CHECKPOINT_EVERY == 0:
            ...
            # Save checkpoint (V2.1: use A5_OUTPUT)
            checkpoint_path = A5_OUTPUT / 'checkpoints' / f'checkpoint_{n_processed}.pkl'
