#!/usr/bin/env python3
"""
Phase B2 (Revised): Full Mechanism Clustering - NO PRUNING (V2.1)
=================================================================

This script processes ALL indicators from A6 without pruning.
...
# V2.1: Labels may be in B35_OUTPUT or use fallback
