#!/usr/bin/env python3
"""
A4 Phase 1: Input Validation and Temporal Alignment Check (V2.1)
...
from v21_config import A3_OUTPUT, A4_OUTPUT, get_input_path
...
def load_inputs():
    ...
    # Load A3 final DAG (V2.1: use A3_OUTPUT from config)
...
def create_input_manifest(edges_df, metadata, alignment_check):
    ...
    output_file = A4_OUTPUT / 'input_manifest.pkl'
